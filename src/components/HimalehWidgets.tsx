      ...
      <div className="relative">
        ...
        {activeWidgetTab === 'compact' && (
          <div
            ...
            className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 text-white p-5 shadow-xl border border-slate-800/90 max-w-md mx-auto"
          >
            {/* Subtle Amber Summit Ambient Light */}
            ...
            <div className="flex items-center justify-between border-b border-slate-800/80 pb-3 mb-3.5">
              <div className="flex items-center gap-2">
                <HimalehLogo variant="crest" size={24} />
                <span className="font-serif font-extrabold text-sm tracking-tight text-slate-100">
                  Himaleh
                </span>
            ...
            <div className="grid grid-cols-2 gap-3 mb-3.5">
              ...
              <div className="p-3 rounded-2xl bg-slate-800/60 border border-slate-700/50">
                ...
                {/* Trail Progress Bar */}
                <div className="h-1.5 w-full bg-slate-700/60 rounded-full mt-2 overflow-hidden">
                  <div
            ...
            {nextRoutine ? (
              ...
              <div className="text-center py-2 text-xs text-amber-300/80 font-medium">
                ...
                <div className="flex items-center justify-between text-[11px] text-slate-400 pt-1">
                  ...
                  {onSelectGoal && (
                    <button
                      ...
                      className="text-amber-400 hover:text-amber-300 font-bold inline-flex items-center gap-0.5 cursor-pointer"
                    >
