...
export const QuickAddRoutineModal: React.FC<QuickAddRoutineModalProps> = ({
  ...
  const timePresets = [
    { label: '07:00 (Morning)', hour: 7, minute: 0 },
    { label: '09:00 (Work)', hour: 9, minute: 0 },
    { label: '18:00 (Evening)', hour: 18, minute: 0 },
    { label: '21:00 (Night)', hour: 21, minute: 0 },
  ];
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md rounded-3xl bg-white dark:bg-neutral-900 shadow-2xl border border-neutral-200 dark:border-neutral-800 p-6 space-y-5"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3.5 py-2.5 text-sm text-neutral-900 dark:text-neutral-100 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
            />
              ...
              {timePresets.map((tp) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-lg py-1.5 px-2 text-xs font-medium border transition cursor-pointer ${
                      isSelected
                        ? 'bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border-emerald-400 dark:border-emerald-600 font-bold'
                        : 'bg-neutral-50 dark:bg-neutral-800/60 text-neutral-700 dark:text-neutral-300 border-neutral-200 dark:border-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-700'
                    }`}
                  >
                    {tp.label}
